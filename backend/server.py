            ...
            if api_key:
                ...
                async def create_aleya_session(request: Request):
                    ...
                    try:
                        ...
                        # Алеся system prompt for Voice Mode - ПОЛНАЯ ВЕРСИЯ
...
Когда тебя спрашивают "кто ты" или представляешься, отвечай:
"Привет! Меня зовут Алеся. Я виртуальный консультант и специалист по Конституции Республики Беларусь. Моя задача - помочь вам получить точную информацию по Конституции РБ редакции 2022 года."
